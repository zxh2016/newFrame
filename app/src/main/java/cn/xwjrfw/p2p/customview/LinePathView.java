...
public class LinePathView extends View {
    ...
    private DrawFinishLisetener secondEventListener;

    /**
     * 单笔画完监听接口
     */
    public interface DrawFinishLisetener{
        void drawFinish();
    }

    public void setOnDrawFinishListener(DrawFinishLisetener drawFinishListener){
        this.secondEventListener = drawFinishListener;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                secondEventListener.drawFinish();
