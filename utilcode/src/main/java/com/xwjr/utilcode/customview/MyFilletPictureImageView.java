 ...
 * 自定义图片View
 * 属性：
 <attr name="mfp_border_color" format="color" />    边框颜色
 <attr name="mfp_border_width" format="dimension" />  边框宽度
 <attr name="mfp_press_alpha" format="integer" />  透明度
 <attr name="mfp_press_color" format="color" />  点击变色
 <attr name="mfp_radius" format="dimension" />  圆角
 <attr name="mfp_shape_type" format="enum">  图片样式 0：默认  1：圆形 2：圆角
 */
...
public class MyFilletPictureImageView extends ImageView {
        // 图片按下的画笔
        ...
        public MyFilletPictureImageView(Context context) {
            super(context);
            init(context, null);
        }

        public MyFilletPictureImageView(Context context, AttributeSet attrs) {
            super(context,attrs);
            init(context, attrs);
        }

        public MyFilletPictureImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        private void init(Context context, AttributeSet attrs) {
            ...
            // 获取控件的属性值
            if (attrs != null) {
                TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.MyFilletPictureImageView);
                borderColor = array.getColor(R.styleable.MyFilletPictureImageView_mfpi_border_color, borderColor);
                borderWidth = array.getDimensionPixelOffset(R.styleable.MyFilletPictureImageView_mfpi_border_width, borderWidth);
                pressAlpha = array.getInteger(R.styleable.MyFilletPictureImageView_mfpi_press_alpha, pressAlpha);
                pressColor = array.getColor(R.styleable.MyFilletPictureImageView_mfpi_press_color, pressColor);
                radius = array.getDimensionPixelOffset(R.styleable.MyFilletPictureImageView_mfpi_radius, radius);
                shapeType = array.getInteger(R.styleable.MyFilletPictureImageView_mfpi_shape_type, shapeType);
                array.recycle();
            }
