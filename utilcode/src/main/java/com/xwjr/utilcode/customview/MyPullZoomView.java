 ...
 * 属性：
 * 使用方式
 * <com.xwjr.utilcode.customview.MyPullZoomView">
 * <LinearLayout>
 * <TextView
 * android:tag="header" />
 * <ImageView
 ...
 * </com.xwjr.utilcode.customview.MyPullZoomView>
 */
public class MyPullZoomView extends ScrollView {
    ...
    public MyPullZoomView(Context context) {
        this(context, null);
    }

    public MyPullZoomView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.scrollViewStyle);
    }

    public MyPullZoomView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MyPullZoomView);
        sensitive = a.getFloat(R.styleable.MyPullZoomView_mpzv_sensitive, sensitive);
        isParallax = a.getBoolean(R.styleable.MyPullZoomView_mpzv_isParallax, isParallax);
        isZoomEnable = a.getBoolean(R.styleable.MyPullZoomView_mpzv_isZoomEnable, isZoomEnable);
        zoomTime = a.getInt(R.styleable.MyPullZoomView_mpzv_zoomTime, zoomTime);
        a.recycle();
