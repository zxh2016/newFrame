package com.xwjr.utilcode.customview.PullToRefreshView;
...
//        ViewCompat.setChildrenDrawingOrderEnabled(this, true);
     ...
     * The first color will also be the color of the bar that grows in getResult
     ...
     * color will also be the color of the bar that grows in getResult to a user
     * swipe gesture.
     *
     * @param colors
     */
...
//                Log.i(Constants.Log,"Down");
//                Log.i(Constants.Log,"mDownX:"+mDownX+"            mDownY:"+mDownY);
            case MotionEvent.ACTION_MOVE:
//                Log.i(Constants.Log,"Move");
                float dy = Math.abs((ev.getY() - mDownY));
                float dx = Math.abs((ev.getX() - mDownX));
//                Log.i(Constants.Log,"dx:"+dx+"            dy:"+dy);
            //防止左划菜单 跟下拉菜单冲出
                if(dx>10){
                    return false;
                }
...
//                Log.i(Constants.Log,"ACTION_POINTER_UP");
                onSecondaryPointerUp(ev);
                break;

            case MotionEvent.ACTION_UP:
//                Log.i(Constants.Log,"ACTION_UP");
            case MotionEvent.ACTION_CANCEL:
//                Log.i(Constants.Log,"ACTION_CANCEL");
                mIsBeingDragged = false;
